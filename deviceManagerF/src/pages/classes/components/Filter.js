...
class Filter extends PureComponent {
  ...
  render() {
    ...
    const { class_id, class_name, student_no, teacher_no } = filter
    ...
    return (
      <Row gutter={24}>
        ...
        <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
          {getFieldDecorator('class_name', { initialValue: class_name })(
            <Search
              placeholder={'搜索班级名称'}
              onSearch={this.handleSubmit}
            />
        ...
        <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
          {getFieldDecorator('teacher_no', { initialValue: teacher_no })(
            <Search
              placeholder={'搜索教师号'}
              onSearch={this.handleSubmit}
            />
